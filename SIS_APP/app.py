...
from database import (
    ...
    get_all_students,
    get_student_by_name,
    delete_student_permanently as delete_db_permanently,
    soft_delete_student as soft_delete_db_student,
    update_student,
)
...
@app.route('/students/delete-confirmation/<int:student_id>', methods=['GET'])
...
def delete_student(student_id):
    success, message = soft_delete_db_student(student_id)
    flash(message, "success" if success else "error")
    return redirect(url_for("students_list"))

@app.route("/students/permanent-delete/<int:student_id>", methods=["POST"])
def permanent_delete_student(student_id):
    success, message = delete_db_permanently(student_id)
    flash(message, "success" if success else "error")
    return redirect(url_for("students_list"))
